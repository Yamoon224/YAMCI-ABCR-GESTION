...
function row_status($x)
{
    if ($x == null) {
        ...
        return '<div class="text-center"><span class="badge bg-warning text-dark">' . lang($x) . '</span></div>';
    } elseif ($x == 'completed' || $x == 'paid' || $x == 'sent' || $x == 'received') {
        return '<div class="text-center"><span class="badge bg-success">' . lang($x) . '</span></div>';
    } elseif ($x == 'partial' || $x == 'transferring') {
        return '<div class="text-center"><span class="badge bg-info text-dark">' . lang($x) . '</span></div>';
    } elseif ($x == 'due') {
        return '<div class="text-center"><span class="badge bg-danger">' . lang($x) . '</span></div>';
    }
    return '<div class="text-center"><span class="badge bg-secondary">' . lang($x) . '</span></div>';
}

...
<div class="card">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown"><a href="<?= admin_url('notifications/add'); ?>" data-bs-toggle="modal"
                                        data-bs-target="#myModal"><i class="icon fa fa-plus"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <!--<p><a href="<?php echo admin_url('notifications/add'); ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo $this->lang->line('add_notification'); ?></a></p>-->
            </div>
        </div>
    </div>
</div>

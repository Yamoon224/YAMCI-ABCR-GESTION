...
<div class="modal-dialog">
    ...
    ?>
        ...
        echo '<div class="well well-sm">' . lang('no_mismatch_found') . '</div>';
                    ...
                    <?php
                    if ($adjustment) {
                        echo '<a href="' . admin_url('products/view_adjustment/' . $adjustment->id) . '" class="btn btn-primary btn-block no-print" data-bs-toggle="modal" data-bs-target="#myModal2">' . lang('view_adjustment') . '</a>';

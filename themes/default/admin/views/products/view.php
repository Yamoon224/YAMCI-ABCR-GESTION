                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu float-end tasks-menus" role="menu"
        ...
        foreach ($images as $ph) {
            ...
            echo '</div>';
                                    ...
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <?php if ($variants) {
                                            ...
                                            <tr>
                                                ...
                                                echo '<span class="badge bg-primary">' . $variant->name . '</span> ';
                                            } ?></td>
                                            </tr>
                                        <?php
                                        } ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <?= $product->details ? '<div class="panel panel-success"><div class="card-header">' . lang('product_details_for_invoice') . '</div><div class="card-body">' . $product->details . '</div></div>' : ''; ?>
                                <?= $product->product_details ? '<div class="panel panel-primary"><div class="card-header">' . lang('product_details') . '</div><div class="card-body">' . $product->product_details . '</div></div>' : ''; ?>
                            ...
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                    <a href="<?= admin_url('products/print_barcodes/' . $product->id) ?>" class="tip btn btn-primary" title="<?= lang('print_barcode_label') ?>">
                                        ...
                                        <span class="d-none d-md-block d-none d-sm-block"><?= lang('print_barcode_label') ?></span>
                                    </a>
                                </div>
                                <div class="btn-group">
                    ...
                    <div class="col-md-12">
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-sm-<?= $purchased ? '6' : '12'; ?>">
                                <div class="card" style="border-top: 1px solid #dbdee0;">
                                    <div class="box-header">

    ...
    <div class="card-body p-3">
        ...
        <?php echo form_close(); ?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                <div
                                    class="card-header"><?= lang('please_select_these_before_adding_product') ?></div>
                                <div class="card-body" style="padding: 5px;">
                                    <?php if ($Owner || $Admin || !$this->session->userdata('warehouse_id')) {
                    ?>
                                        <div class="col-md-4">
                    ...
                    echo form_input($warehouse_input);
                            ...
                            <div class="card card-body p-2 mb-2">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-barcode"></i></span>
                                        ...
                                        <a href="#" id="addManually" class="btn btn-outline-secondary tip" title="<?= lang('add_product_manually') ?>">
                                            <i class="fa fa-plus-circle"></i>
                                        </a>
                                        <?php } if ($Owner || $Admin || $GP['sales-add_gift_card']) { ?>
                                        <a href="#" id="sellGiftCard" class="btn btn-outline-secondary tip" title="<?= lang('sell_gift_card') ?>">
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable" class="table items table-striped table-bordered table-sm table-hover sortable_table">
                                        <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <?= lang('subtotal'); ?>
                                                (<span class="currency"><?= isset($default_currency->code) ? $default_currency->code : '' ?></span>)
                                            </th>
                        ...
                        <div id="payments" style="display: none;">
                            <div class="col-md-12">
                                <div class="card card-body p-3 well_1">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                ...
                <div id="bottom-total" class="card card-body p-2" style="margin-bottom: 0;">
                    <table class="table table-bordered table-sm totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <?php if ($Owner || $Admin || $this->session->userdata('allow_discount')) {
                            ?>
                            <td><?= lang('order_discount') ?> <span class="totals_val float-end" id="tds">0.00</span></td>
                            <?php
                        }?>
                            <?php if ($Settings->tax2) {
                            ?>
                                <td><?= lang('order_tax') ?> <span class="totals_val float-end" id="ttax2">0.00</span></td>
                            <?php
                        } ?>
                            <td><?= lang('shipping') ?> <span class="totals_val float-end" id="tship">0.00</span></td>
                            <td><?= lang('grand_total') ?> <span class="totals_val float-end" id="gtotal">0.00</span></td>
                        </tr>
                    </table>
                </div>

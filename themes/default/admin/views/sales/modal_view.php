        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <?php if ($customer->award_points != 0 && $Settings->each_spent > 0) {
                    ?>
                <div class="col-xs-5 float-start">
                    <div class="well well-sm">
                        <?=
            ...
            <?php if (!$Supplier || !$Customer) {
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/add_payment/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('add_payment') ?>" data-bs-toggle="modal" data-bs-target="#myModal2">
                                <i class="fa fa-dollar"></i>
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('payment') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/add_delivery/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('add_delivery') ?>" data-bs-toggle="modal" data-bs-target="#myModal2">
                                <i class="fa fa-truck"></i>
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('delivery') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/email/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">
                                <i class="fa fa-envelope-o"></i>
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('email') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/pdf/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('download_pdf') ?>">
                                <i class="fa fa-download"></i>
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('pdf') ?></span>
                            </a>
                        </div>
                        <?php if (!$inv->sale_id) {
                            ?>
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/edit/' . $inv->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
                                ...
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('edit') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">

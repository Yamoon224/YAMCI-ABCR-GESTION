            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    foreach ($rows as $row) :
                        ?>
                            <tr>
                                ...
                                ?>
                                <td class="text-right" style="vertical-align:middle; width:110px;"><?= $this->sma->formatMoney($row->subtotal); ?></td>
                            </tr>
                            <?php
                            $r++;
                    endforeach;
                        ...
                        foreach ($return_rows as $row) :
                            ?>
                                ...
                                <?php if ($Settings->indian_gst) {
                                    ...
                                    <td class="text-right" style="width:90px;"><?= $this->sma->formatMoney($row->unit_price); ?></td>
                                <?php
                                if ($Settings->tax1 && $inv->product_tax > 0) {
                                ...
                                if ($Settings->product_discount && $inv->product_discount != 0) {
                                    ...
                                    <td class="text-right" style="width:110px;"><?= $this->sma->formatMoney($row->subtotal); ?></td>
                                </tr>
                                <?php
                                $r++;
                        endforeach;
                    ...
                    <?php if ($inv->grand_total != $inv->total) {
                        ?>
                        <tr>
                            <td class="text-right" colspan="<?= $tcol; ?>"><?= lang('total'); ?>
                    ...
                    <tr>
                        <td class="text-right" colspan="<?= $col; ?>" style="font-weight:bold;"><?= lang('paid'); ?>
                            (<?= $default_currency->code; ?>)
                        </td>
                        <td class="text-right" style="font-weight:bold;"><?= $this->sma->formatMoney($return_sale ? ($inv->paid + $return_sale->paid) : $inv->paid); ?></td>
                    </tr>
                    <tr>
                        <td class="text-right" colspan="<?= $col; ?>" style="font-weight:bold;"><?= lang('balance'); ?>
                            (<?= $default_currency->code; ?>)
                        </td>

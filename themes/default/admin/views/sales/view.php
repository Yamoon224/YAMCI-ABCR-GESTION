        ...
        <?php if (!$Supplier || !$Customer) {
            ...
            <div class="buttons">
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/payments/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('view_payments') ?>">
                            <i class="fa fa-money"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('view_payments') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/add_payment/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('add_payment') ?>">
                            <i class="fa fa-money"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('add_payment') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/email/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('email') ?>">
                    ...
                    <?php if (!$inv->sale_id) {
                        ?>
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/add_delivery/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('add_delivery') ?>">
                            <i class="fa fa-truck"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('add_delivery') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        <a href="#" class="tip btn btn-danger bpo"
                            ...
                            <span class="d-none d-md-block d-none d-sm-block"><?= lang('delete') ?></span>
                        </a>
                    </div>
                        <?php
                    } ?>

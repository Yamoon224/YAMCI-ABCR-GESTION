                ...
                <table class="table table-condensed">
                    <tbody>
                        ...
                        foreach ($rows as $row) {
                            ...
                            echo '<tr><td colspan="2" class="no-border">#' . $r . ': &nbsp;&nbsp;' . product_name($row->product_name, ($printer ? $printer->char_per_line : null)) . ($row->variant ? ' (' . $row->variant . ')' : '') , ($row->serial_no ? '<br>' . $row->serial_no : '') . '<span class="float-end">' . ($row->tax_code ? '*' . $row->tax_code : '') . '</span></td></tr>';
            ...
            if ($modal) {
                ...
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <div class="btn-group" role="group">
                        ...
                        // echo '<button onclick="printDot();" class="btn btn-block btn-secondary">' . lang('print_dot') . '</button>';
                        } else {

                ...
                <table class="table table-bordered table-striped">
                    ...
                    if (!empty($registers)) {
                        foreach ($registers as $register) {
                            ...
                            echo '<td width="50px;"><a href="' . admin_url('pos/close_register/' . $register->user_id) . '" data-bs-target="#myModal" data-bs-toggle="modal"><span class="badge bg-danger"><i class="fa fa-times"></i> ' . lang('close_register') . '</span></a></td>';
                            echo '</tr>';
                        }
                    } else {
                        echo '<tr>';

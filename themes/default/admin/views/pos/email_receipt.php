                        ...
                        <td>
                            ...
                            <div style="clear:both;height:15px;"></div>
                                <div id="receiptData" style="border:1px solid #DDD; padding:10px; text-align:center;">
                                        ...
                                        <table width="100%" style="margin:15px 0;">
                                            <tbody>
                                                ...
                                                foreach ($rows as $row) {
                                                    ...
                                                    echo '<tr><td colspan="2" style="text-align:left;border:0;">#' . $r . ': &nbsp;&nbsp;' . $row->product_name . ($row->variant ? ' (' . $row->variant . ')' : '') . '<span class="float-end">' . ($row->tax_code ? '*' . $row->tax_code : '') . '</span></td></tr>';
                                        ...
                                        if ($return_payments) {
                                            echo '<div style="text-align:left;padding-top:10px;"><strong>' . lang('return_payments') . '</strong></div><table class="table table-striped table-sm"><tbody>';

            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang('type', 'type'); ?>
                        <?php
                        $topts = ['network' => lang('network'), 'windows' => lang('windows'), 'linux' => lang('linux')];
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $popts = ['default' => lang('default'), 'simple' => lang('simple'), 'SP2000' => lang('star_branded'), 'TEP-200M' => lang('epson_tep'), 'P822D' => lang('P822D')];
                        ?>

        ...
        <div class="container">
            ...
            <div class="header-nav">
                <ul class="nav navbar-nav float-end">
                    <li class="dropdown">
                        <a class="btn account dropdown-toggle" data-bs-toggle="dropdown" href="#">
                            ...
                            <div class="user d-none d-md-blockall">
                ...
                <ul class="nav navbar-nav float-end">
                    ...
                    <?php if ($Owner) {
                        ?>
                        <li class="dropdown d-none d-md-block d-none d-md-blockall">
                    ...
                    ?>
                    <li class="dropdown d-none d-sm-block d-none d-md-blockall">
                        <a class="btn pos-tip" title="<?=lang('calculator')?>" data-placement="bottom" href="#" data-bs-toggle="dropdown">
                            <i class="fa fa-calculator"></i>
                        </a>
                        <ul class="dropdown-menu float-end calc">
                    ...
                    <li class="dropdown d-none d-md-block d-none d-md-blockall">
                        <a class="btn pos-tip" title="<?=lang('shortcuts')?>" data-placement="bottom" href="#" data-bs-toggle="modal" data-bs-target="#sckModal">
                            <i class="fa fa-key"></i>
                        </a>
                    </li>
                    <li class="dropdown d-none d-md-blockall">
                    ...
                    <li class="dropdown d-none d-md-blockall">
                        <a class="btn bdarkGreen pos-tip" id="register_details" title="<span><?=lang('register_details')?></span>" data-placement="bottom" data-html="true" href="<?=admin_url('pos/register_details')?>" data-bs-toggle="modal" data-bs-target="#myModal">
                            <i class="fa fa-check-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="close_register" title="<span><?=lang('close_register')?></span>" data-placement="bottom" data-html="true" data-bs-backdrop="static" href="<?=admin_url('pos/close_register')?>" data-bs-toggle="modal" data-bs-target="#myModal">
                            <i class="fa fa-times-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown d-none d-md-blockall">
                        <a class="btn borange pos-tip" id="add_expense" title="<span><?=lang('add_expense')?></span>" data-placement="bottom" data-html="true" href="<?=admin_url('purchases/add_expense')?>" data-bs-toggle="modal" data-bs-target="#myModal">
                    ...
                    <?php if ($Owner) {
                        ?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_profit" title="<span><?=lang('today_profit')?></span>" data-placement="bottom" data-html="true" href="<?=admin_url('reports/profit')?>" data-bs-toggle="modal" data-bs-target="#myModal">
                    ...
                    <?php if ($Owner || $Admin) {
                        ?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_sale" title="<span><?=lang('today_sale')?></span>" data-placement="bottom" data-html="true" href="<?=admin_url('pos/today_sale')?>" data-bs-toggle="modal" data-bs-target="#myModal">
                ...
                <ul class="nav navbar-nav float-end d-none d-md-blockallest">
                    <li class="dropdown">
    ...
    <div id="content">
        <div class="c1">
            <div class="pos">
                <?php
                if ($error) {
                    echo '<div class="alert alert-danger"><button type="button" class="close fa-2x" data-bs-dismiss="alert">&times;</button>' . $error . '</div>';
                }
                ?>
                <?php
                if ($message) {
                    echo '<div class="alert alert-success"><button type="button" class="close fa-2x" data-bs-dismiss="alert">&times;</button>' . $message . '</div>';
                }
                ?>
                <div id="pos">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                    ...
                                    <div class="input-group-addon no-print" style="padding: 2px 7px; border-left: 0;">
                                        <a href="#" id="view-customer" class="external" data-bs-toggle="modal" data-bs-target="#myModal">
                                ...
                                <?php if ($Owner || $Admin || $GP['customers-add']) {
                                    ...
                                    <div class="input-group-addon no-print" style="padding: 2px 8px;">
                                        <a href="<?=admin_url('customers/add'); ?>" id="add-customer" class="external" data-bs-toggle="modal" data-bs-target="#myModal">
...
<div class="modal fade in" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="payModalLabel" data-bs-backdrop="static"
     aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-xs btn-secondary no-print float-end" style="margin-right:15px;" onclick="window.print();">

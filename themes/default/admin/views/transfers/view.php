    ...
    ?>
            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-6 float-end text-right order_barcodes">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-xs-offset-1 float-end">
            ...
            <div class="buttons">
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= admin_url('transfers/email/' . $transfer->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">

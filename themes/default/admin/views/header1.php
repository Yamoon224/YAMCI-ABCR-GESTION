...
<div id="app_wrapper">
    <header id="header" class="navbar">
        <div class="container">
            ...
            <div class="btn-group d-block d-sm-none float-end btn-visible-sm">
                <button class="navbar-toggle btn" type="button" data-bs-toggle="collapse" data-bs-target="#sidebar_menu">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav float-end">
                    <li class="dropdown d-none d-sm-block"><a class="btn tip" title="<?= lang('dashboard') ?>" data-placement="bottom" href="<?= admin_url('welcome') ?>"><i class="fa fa-dashboard"></i></a></li>
                    <?php if (SHOP) { ?>
                    <li class="dropdown d-none d-sm-block"><a class="btn tip" title="<?= lang('shop') ?>" data-placement="bottom" href="<?= base_url() ?>"><i class="fa fa-shopping-cart"></i></a></li>
                    <?php } ?>
                    <?php if (POS) { ?>
                    <a href="<?= admin_url('pos') ?>" class="btn">
                        <span class="fa fa-th-large"></span>
                    ...
                    <li class="dropdown d-none d-sm-block">
                        <a class="btn tip" title="<?= lang('calculator') ?>" data-placement="bottom" href="#" data-bs-toggle="dropdown">
                    ...
                    <?php if ($info) { ?>
                        <li class="dropdown d-none d-md-block">
                            <a class="btn tip" title="<?= lang('notifications') ?>" data-placement="bottom" href="#" data-bs-toggle="dropdown">
                                <i class="fa fa-info-circle"></i>
                                <span class="number blightOrange black"><?= sizeof($info) ?></span>
                            </a>
                            <ul class="dropdown-menu float-end content-scroll">
                    ...
                    <?php if ($events) {
                        ?>
                        <li class="dropdown d-none d-sm-block">
                            <a class="btn tip" title="<?= lang('calendar') ?>" data-placement="bottom" href="#" data-bs-toggle="dropdown">
                    ...
                    <li class="dropdown d-none d-md-block">
                        <a class="btn tip" title="<?= lang('styles') ?>" data-placement="bottom" data-bs-toggle="dropdown"
                           href="#">
                    ...
                    <li class="dropdown d-none d-sm-block">
                        <a class="btn tip" title="<?= lang('language') ?>" data-placement="bottom" data-bs-toggle="dropdown"
                           href="#">
                    ...
                    <?php if (($Owner || $Admin || $GP['reports-quantity_alerts'] || $GP['reports-expiry_alerts']) && ($qty_alert_num > 0 || $exp_alert_num > 0 || $shop_sale_alerts)) {
                        ...
                        <li class="dropdown d-none d-md-block">
                            <a class="btn blightOrange tip" title="<?= lang('alerts') ?>"
                                data-placement="left" data-bs-toggle="dropdown" href="#">
                            ...
                            <ul class="dropdown-menu float-end">
                                ...
                                <li>
                                    <a href="<?= admin_url('reports/quantity_alerts') ?>" class="">
                                        <span class="badge bg-danger float-end" style="margin-top:3px;"><?= $qty_alert_num; ?></span>
                                ...
                                <li>
                                    <a href="<?= admin_url('reports/expiry_alerts') ?>" class="">
                                        <span class="badge bg-danger float-end" style="margin-top:3px;"><?= $exp_alert_num; ?></span>
                                ...
                                <li>
                                    <a href="<?= admin_url('sales?shop=yes&delivery=no') ?>" class="">
                                        <span class="badge bg-danger float-end" style="margin-top:3px;"><?= $shop_sale_alerts; ?></span>
                                ...
                                <li>
                                    <a href="<?= admin_url('sales?shop=yes&attachment=yes') ?>" class="">
                                        <span class="badge bg-danger float-end" style="margin-top:3px;"><?= $shop_payment_alerts; ?></span>
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    ...
                                    <li id="purchases_add_expense">
                                        <a class="submenu" href="<?= admin_url('purchases/add_expense'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                            <i class="fa fa-plus-circle"></i>
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <li id="billers_index">
                                        <a class="submenu" href="<?= admin_url('billers/add'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    ...
                                    <li id="customers_index">
                                        <a class="submenu" href="<?= admin_url('customers/add'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    ...
                                    <li id="suppliers_index">
                                        <a class="submenu" href="<?= admin_url('suppliers/add'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                ...
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_change_logo">
                                            <a href="<?= admin_url('system_settings/change_logo') ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            ...
                            ?>
                            <li class="right_log d-none d-sm-block">
                                <?= lang('your_ip') . ' ' . $ip_address . " <span class='d-none d-md-block'>( " . lang('last_login_at') . ': ' . date($dateFormats['php_ldate'], $this->session->userdata('old_last_login')) . ' ' . ($this->session->userdata('last_ip') != $ip_address ? lang('ip:') . ' ' . $this->session->userdata('last_ip') : '') . ' )</span>' ?>
                            </li>
                        </ul>
                    </div>
                </div>

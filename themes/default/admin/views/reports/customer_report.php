                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?php echo admin_form_open('reports/customer_report/' . $user_id, 'autocomplete="off"'); ?>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="payform">
                            ...
                            <?php echo admin_form_open('reports/customer_report/' . $user_id . '/#payments-con', 'autocomplete="off"'); ?>
                            <div class="row">

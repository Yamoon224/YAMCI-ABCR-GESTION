                    ...
                    <table class="table table-bordered table-striped dfTable reports-table">
                        ...
                        <tr>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/01'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_january'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/02'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_february'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/03'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_march'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/04'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_april'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/05'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_may'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/06'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_june'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/07'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_july'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/08'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_august'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/09'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_september'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/10'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_october'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/11'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_november'); ?>
                                </a>
                            </td>
                            <td class="bold text-center">
                                <a href="<?= admin_url('reports/monthly_profit/' . $year . '/12'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                    <?= lang('cal_december'); ?>
                                </a>
                            </td>
                        </tr>

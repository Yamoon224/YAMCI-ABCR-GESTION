...
<div class="card">
    ...
    ?>
                        ...
                        <li>
                            <a href="<?= admin_url('quotes/email/' . $inv->id) ?>" data-bs-target="#myModal" data-bs-toggle="modal">
                ...
                <?php if ($inv->attachment) {
                    ...
                    <div class="btn-group">
                        <a href="<?= admin_url('welcome/download/' . $inv->attachment) ?>" class="tip btn btn-primary" title="<?= lang('attachment') ?>">
                            ...
                            <span class="d-none d-md-block d-none d-sm-block"><?= lang('attachment') ?></span>
                        </a>
                    </div>
                <?php
                            } ?>
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/add/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('create_invoice') ?>">
                            <i class="fa fa-plus-circle"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('create_invoice') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        <a href="<?= admin_url('quotes/email/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-info tip" title="<?= lang('email') ?>">

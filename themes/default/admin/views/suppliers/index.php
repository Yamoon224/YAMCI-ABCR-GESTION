            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('suppliers/add'); ?>" data-bs-toggle="modal" data-bs-target="#myModal" id="add">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_supplier'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('suppliers/import_csv'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">

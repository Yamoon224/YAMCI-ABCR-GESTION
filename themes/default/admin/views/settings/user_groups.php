            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('system_settings/create_group'); ?>" data-bs-toggle="modal" data-bs-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_group') ?></a></li>

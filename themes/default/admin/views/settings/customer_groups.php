            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo admin_url('system_settings/add_customer_group'); ?>" data-bs-toggle="modal" data-bs-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_customer_group') ?></a></li>

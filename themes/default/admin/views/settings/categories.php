            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('system_settings/add_category'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_category') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo admin_url('system_settings/import_categories'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">

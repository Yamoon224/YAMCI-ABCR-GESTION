...
<div class="card">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('purchases/payments/' . $inv->id) ?>" data-bs-target="#myModal" data-bs-toggle="modal">
                                <i class="fa fa-money"></i> <?= lang('view_payments') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('purchases/add_payment/' . $inv->id) ?>" data-bs-target="#myModal" data-bs-toggle="modal">
    ...
    echo ' <a data-bs-target="#myModal2" data-bs-toggle="modal" href="' . admin_url('purchases/modal_view/' . $inv->return_id) . '"><i class="fa fa-external-link no-print"></i></a><br>';
    echo '</p></div>';
} ?>
        ...
        <?php if (!$Supplier || !$Customer) {
            ...
            <div class="buttons">
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= admin_url('purchases/payments/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('view_payments') ?>">
                            <i class="fa fa-money"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('view_payments') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('purchases/add_payment/' . $inv->id) ?>" class="tip btn btn-primary tip" title="<?= lang('add_payment') ?>" data-bs-target="#myModal" data-bs-toggle="modal">
                            <i class="fa fa-money"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('add_payment') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('purchases/email/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('email') ?>">
                            <i class="fa fa-envelope-o"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('email') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('purchases/pdf/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('download_pdf') ?>">
                            <i class="fa fa-download"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('pdf') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?= admin_url('purchases/edit/' . $inv->id) ?>" class="tip btn btn-warning tip" title="<?= lang('edit') ?>">
                            <i class="fa fa-edit"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('edit') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="#" class="tip btn btn-danger bpo" title="<b><?= $this->lang->line('delete_purchase') ?></b>"
                           ...
                           data-html="true" data-placement="top">
                            <i class="fa fa-trash-o"></i> <span class="d-none d-md-block d-none d-sm-block"><?= lang('delete') ?></span>
                        </a>
                    </div>
                </div>
            </div>

            ...
            <?php if (!$Supplier || !$Customer) {
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases/add_payment/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal2" class="tip btn btn-primary" title="<?= lang('add_payment') ?>">
                                <i class="fa fa-dollar"></i>
                                <span class="d-none d-md-block d-none d-sm-block"><?= lang('add_payment') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases/email/' . $inv->id) ?>" data-bs-toggle="modal" data-bs-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">

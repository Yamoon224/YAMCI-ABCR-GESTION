                                ...
                                <div class="card-body" style="padding: 5px;">
                                    ...
                                    ?>
                                                    <div class="input-group-addon no-print" style="padding: 2px 5px; border-left: 0;">
                                                        <a href="#" id="view-supplier" class="external" data-bs-toggle="modal" data-bs-target="#myModal">
                                    ...
                                    ?>
                                                <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                                    <a href="<?= admin_url('suppliers/add'); ?>" id="add-supplier" class="external" data-bs-toggle="modal" data-bs-target="#myModal">

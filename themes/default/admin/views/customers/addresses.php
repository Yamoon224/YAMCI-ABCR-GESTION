...
<div class="modal-dialog modal-lg">
    ...
    ?>
        ...
        <div class="modal-footer">
            <a href="<?= admin_url('customers/add_address/' . $company->id); ?>" class="btn btn-primary float-start" data-toggle='modal' data-target='#myModal2'><?= lang('add_address'); ?></a>

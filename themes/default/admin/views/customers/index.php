            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu float-end tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('customers/add'); ?>" data-bs-toggle="modal" data-bs-target="#myModal" id="add">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_customer'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('customers/import_csv'); ?>" data-bs-toggle="modal" data-bs-target="#myModal">

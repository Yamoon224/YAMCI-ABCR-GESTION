...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer no-print">
                <button type="button" class="btn btn-secondary float-start" data-bs-dismiss="modal"><?= lang('close'); ?></button>
    ...
    ?>
        ...
        ?>
                    <a href="<?=admin_url('customers/edit/' . $customer->id); ?>" data-bs-toggle="modal" data-bs-target="#myModal2" class="btn btn-primary"><?= lang('edit_customer'); ?></a>
                <?php
    } ?>
            </div>

...
<div class="modal-dialog modal-lg">
    ...
    foreach ($users as $user) {
        echo '<tr>' .
                                ...
                                '<td>' . $user->email . '</td>' .
                                '<td class="text-center">' . ($user->active ? '<a href="' . admin_url() . 'auth/deactivate/' . $user->id . '" data-bs-toggle="modal" data-bs-target="#myModal2" class="tip"><span class="badge bg-success"><i class="fa fa-check"></i> ' . lang('active') . '</span></a>' : '<a href="' . admin_url() . 'auth/activate/' . $user->id . '"><span class="badge bg-danger"><i class="fa fa-times"></i> ' . lang('inactive') . '</span></a>') . '</td>' .
